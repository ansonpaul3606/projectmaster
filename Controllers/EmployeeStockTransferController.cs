...
{
    [CheckSessionTimeOut]
    public class EmployeeStockTransferController : Controller
    {
        ...
        public ActionResult LoadFormEmployeeStockTransfer(string TransMode)
        {
          ...
          companyKey: _userLoginInfo.CompanyKey
            ...
            return PartialView("_AddEmployeeStockTransfer",list);
        }
        [HttpPost]
        ...
        public ActionResult GetRequestSearch(int BranchID, int ?BranchIDTo, int DepartmentID, int ?DepartmentIDTo, int ?EmployeeID, int ?EmployeeIDTo,string TransMode)
        {
            #region ::  Check User Session to verifyLogin  ::
            ...
            var searchInfo = objprd.GetSearchRequestdata(companyKey: _userLoginInfo.CompanyKey, input: new EmployeeStockTransferModel.SearchInput
            {
               
                BranchID=BranchID,
                BranchIDTo= (BranchIDTo.HasValue) ? BranchIDTo.Value : 0,
                
                DepartmentIDTo = (DepartmentIDTo.HasValue) ? DepartmentIDTo.Value : 0,
        ...
        [HttpPost]
        public ActionResult GetStocktransferInfo(EmployeeStockTransferModel.EmployeeStockTransferView data)
        {
            if (Session["UserLoginInfo"] is null)
            {
                return Json(new
            ...
            var subtable = objprd.Fillproduct(companyKey: _userLoginInfo.CompanyKey, input: new EmployeeStockTransferModel.EmployeeStockTransferSubSelect
            {
        ...
        // Get StockTransferUnit 
        public ActionResult GetStockTransferUnit(EmployeeStockTransferModel.ProductWiseUnitVue data)
        {
            #region ::  Check User Session to verifyLogin  ::
