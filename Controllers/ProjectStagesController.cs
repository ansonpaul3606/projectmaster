...
namespace PerfectWebERP.Controllers
{
    ...
    public class ProjectStagesController : Controller
    {
            ...
            return PartialView("_AddProjectStages", MUList);
            }
        ...
        [HttpPost]
            ...
            [HttpPost]
            [ValidateAntiForgeryToken]
            public ActionResult AddNewProjectStagesDetails(ProjectStagesModel.ProjectStagesInputFromViewModel data)
            {
            ...
            [HttpPost]
            [ValidateAntiForgeryToken]
            public ActionResult UpdateProjectStagesDetails(ProjectStagesModel.ProjectStagesInputFromViewModel data)
            {
